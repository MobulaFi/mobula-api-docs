...
You can query up to 500 assets as the same time (even tho if you are facing this you might want to use [our data streams](/api-reference/beta/introduction_highlevel)) - you must input a blockchain IF you send a smart-contract, but it's not mandatory otherwise (blockchain format can be found [here](/blockchains/intro-blockchains)).
...
<Tip>
  Need more than 500 assets? You can use the [/all](/api-reference/endpoint/all)
