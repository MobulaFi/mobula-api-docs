...
<Steps>
  ...
  <Step title="Execute the API Call">
    ...
    **Using cURL**:
    ```bash
    curl --request GET \
    --url 'https://production-api.mobula.io/api/1/market/history?asset=Floki&from=1697648158'
    ```

    **Using Axios**:
    ```javascript
    import axios from "axios";
    axios.get('https://production-api.mobula.io/api/1/market/history?asset=Floki&from=1697648158')
