...
<Steps>
  ...
  <Step title="Execute the API Call">
    ...
    **Using cURL**:
    ```bash
    curl --request GET \
    --url 'https://production-api.mobula.io/api/1/wallet/history?wallet=0x77A89C51f106D6cD547542a3A83FE73cB4459135&from=1650788304000&to=1651940430000'
    ```

    **Using Axios**:
    ```javascript
    import axios from "axios";
    axios.get('https://production-api.mobula.io/api/1/wallet/history?wallet=0x77A89C51f106D6cD547542a3A83FE73cB4459135&from=1650788304000&to=1651940430000')
