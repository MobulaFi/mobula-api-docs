...
<Steps>
  ...
  <Step title="Execute the API Call">
    ...
    **Using cURL**:
    ```bash
    curl --location --request GET 'https://production-api.mobula.io/api/1/wallet/portfolio?wallet=0x77A89C51f106D6cD547542a3A83FE73cB4459135'
    ```

    **Using Axios**:
    ```javascript
    import axios from "axios";
    axios.get('https://production-api.mobula.io/api/1/wallet/portfolio?wallet=0x77A89C51f106D6cD547542a3A83FE73cB4459135')
