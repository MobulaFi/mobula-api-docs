...
- Fetch up to 500 assets at once with `market/multi-data` endpoint (check [here](/api-reference/endpoint/market-multi-data) for more details)
...
- Fetch historical price data with `market/history` endpoint (check [here](/api-reference/endpoint/market-history) for more details)
