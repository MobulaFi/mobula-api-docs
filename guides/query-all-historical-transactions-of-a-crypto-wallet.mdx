...
<Steps>
  ...
  <Step title="Perform the API Request">
    Execute the API call using cURL, Axios, or the Mobula SDK:

    **Using cURL**:
    ```bash
    curl --location --request GET 'https://api.mobula.io/wallet/transactions?wallet=0x77A89C51f106D6cD547542a3A83FE73cB4459135'
    ```

    **Using Axios**:
    ```javascript
    import axios from "axios";
    axios.get('https://api.mobula.io/wallet/transactions?wallet=0x77A89C51f106D6cD547542a3A83FE73cB4459135')
