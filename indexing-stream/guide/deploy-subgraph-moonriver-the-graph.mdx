---
title: "Deploying an Indexer (Subgraph) on Moonriver with The Graph"
description: "Step-by-step guide for deploying a subgraph on Moonriver using The Graph for efficient blockchain data indexing and querying."
---
...
<Steps>
  ...
  <Step title="Deploy to Mobula's Moonriver Node">
    ...
    ```bash
    graph deploy --node http://subgraph.mobula.io:8020 --ipfs http://subgraph.mobula.io:5001 --network moonriver
    ```
  </Step>
