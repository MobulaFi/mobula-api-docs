---
title: "Deploying an Indexer (Subgraph) on Scroll with The Graph"
description: "Find out how to deploy a subgraph on Scroll using The Graph for efficient blockchain data indexing and querying."
---
...
<Steps>
  ...
  <Step title="Deploy to Mobula's Scroll Node">
    ...
    ```bash
    graph deploy --node http://subgraph.mobula.io:8020 --ipfs http://subgraph.mobula.io:5001 --network scroll
    ```
  </Step>
