---
title: "Deploy an Indexer (Subgraph) on Base with The Graph"
description: "Guide to deploying a subgraph on Base using The Graph for efficient blockchain data indexing and querying."
---
...
<Steps>
  ...
  <Step title="Deploy to Mobula's Base Node">
    Use the following command to deploy your subgraph:

    ```bash
    graph deploy --node https://subgraph.mobula.io:8020 --ipfs https://subgraph.mobula.io:5001 --network base
    ```
  </Step>
