---
title: "Deploy an Indexer (Subgraph) on Metis with The Graph"
description: "Step-by-step guide for deploying a subgraph on Metis using The Graph for efficient blockchain data indexing and querying."
---
...
<Steps>
  ...
  <Step title="Deploy to Mobula's Metis Node">
    Use the following command to deploy your subgraph:

    ```bash
    graph deploy --node http://subgraph.mobula.io:8020 --ipfs http://subgraph.mobula.io:5001 --network metis
    ```
  </Step>
