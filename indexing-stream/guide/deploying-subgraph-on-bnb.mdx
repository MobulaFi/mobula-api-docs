---
title: "Deploy a Subgraph on BNB Smart Chain"
description: "Step-by-step guide on deploying a subgraph on BNB Smart Chain using Mobula's infrastructure for optimized blockchain data indexing."
---
...
<Steps>
  <Step title="Prepare Your Subgraph">
    Make sure your subgraph is configured for BNB Smart Chain. Update your `subgraph.yaml` file to point to BSC-specific contracts and events. If you don’t have a subgraph, you can clone the Uniswap V2 (Linkswap) subgraph template and customize it for BSC:

    ```bash
    git clone <https://github.com/ChristianOGB/univ2-subgraph-bnb>
    ```
  </Step>
...
Keep your subgraph regularly updated to ensure it remains compatible with the latest BNB Smart Chain network changes. Thoroughly test your subgraph on a testnet before deploying to the mainnet. Continuously monitor its performance and optimize queries for greater efficiency.
