---
title: "Deploying an Indexer (Subgraph) on Aurora with The Graph"
description: "Step-by-step guide to deploying a subgraph on Aurora using Mobula's infrastructure for efficient blockchain data indexing and querying."
---
...
<Steps>
  ...
  <Step title="Deploy to Mobula's Aurora Node">
    Use the following command to deploy your subgraph:

    ```bash
    graph deploy --node http://subgraph.mobula.io:8020 --ipfs http://subgraph.mobula.io:5001 --network aurora
    ```
  </Step>
